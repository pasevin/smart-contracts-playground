...
// async function main() {
//   const UpgradeERC20UUPS = await ethers.getContractFactory("UpgradeERC20UUPS");
//   const upgradeERC20UUPS = await upgrades.deployProxy(UpgradeERC20UUPS);
//   await upgradeERC20UUPS.deployed();
//   console.log("UpgradeERC20UUPS deployed to:", upgradeERC20UUPS.address);
// }
